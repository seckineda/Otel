namespace Otel
{
    ...
    public class OtelContext : DbContext
    {
        ...
        // 'Otel.OtelContext' database on your LocalDb instance. 
        // 
        ...
        public virtual DbSet<OtelOzelligi> OtelOzellikler { get; set; }
        ...
        public virtual DbSet<Yýldýz> Yýldýzlar { get; set; }
